      ...
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          {!showPaymentSection ? (
            ...
            <div className="px-6 py-4 animate-slideUp space-y-6">
              <button 
                onClick={() => setShowPaymentSection(false)}
                className="flex items-center gap-2 text-[#4B2E2E]/60 hover:text-[#4B2E2E] transition-colors text-[10px] font-black uppercase tracking-widest mb-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex rounded-xl overflow-hidden border-2 border-[#4B2E2E]/10 p-1 bg-white">
                  <button
                    ...
                    className={`flex-1 py-3 rounded-lg font-black text-[10px] uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all duration-300 ${
                      mode === "delivery"
                ...
                <div className="grid grid-cols-1 gap-2.5">
                  <input
                    ...
                    className="bg-white border-2 border-[#4B2E2E]/5 p-3.5 rounded-xl w-full text-xs text-[#4B2E2E] focus:outline-none focus:border-[#4B2E2E] placeholder:text-[#4B2E2E]/20 font-bold shadow-sm"
                  />
                  <input
                    type="tel"
                  ...
                  {mode === "delivery" && (
                    <input
                      ...
                      className="bg-white border-2 border-[#4B2E2E]/5 p-3.5 rounded-xl w-full text-xs text-[#4B2E2E] focus:outline-none focus:border-[#4B2E2E] placeholder:text-[#4B2E2E]/20 font-bold shadow-sm animate-fadeIn"
                    />
                  )}
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 animate-fadeIn">
                    {stores.map((s) => (
                      <button
                        ...
                        className={`text-center px-1 py-2 rounded-lg border-2 font-black text-[9px] leading-tight uppercase transition-all duration-300 ${
                          store === s.id
              ...
              <div className="space-y-3 pt-2">
                <p className="text-[10px] font-black uppercase text-[#4B2E2E]/40 tracking-widest pl-1">Payment Method</p>
                <div className="flex gap-2 p-1 bg-white rounded-xl border-2 border-[#4B2E2E]/10">
                  <button
                    ...
                    className={`flex-1 py-2.5 rounded-lg font-black text-[10px] uppercase tracking-wider transition-all duration-300 ${
                      paymentMethod === "cash"
              ...
              {/* Final Footer in Step 2 */}
              <div className="pt-4 border-t border-[#4B2E2E]/10">
                {mode === "delivery" && (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className={`flex-1 bg-[#25D366] text-white py-4 rounded-full font-bold text-sm hover:bg-[#1ebe57] transition-all flex items-center justify-center gap-2 shadow-lg disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed ${
